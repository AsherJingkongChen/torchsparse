...
__global__ void __launch_bounds__(64) conv_backward_cuda_setting2_mode1_bf16bf16f32(int M_fwd, int64_t K_original, int64_t N, int kernel_volume, int split_k_iters, int split_mask_len, int reduced_mask_len, int reorder_loc_len, __nv_bfloat16*__restrict__ A, __nv_bfloat16*__restrict__ B, int *__restrict__ reduced_mask, int *__restrict__ out_in_map, int *__restrict__ reorder_loc, __nv_bfloat16*__restrict__ C)
{
  float C_warp[32];
  __shared__ __nv_bfloat16 A_shared[2560];
...
template <int K_ld_factor, int N_ld_factor, bool K_ld_check, bool N_ld_check>
__global__ void __launch_bounds__(32) conv_backward_cuda_setting1_mode1_f32f32f32(int M_fwd, int64_t K_original, int64_t N, int kernel_volume, int split_k_iters, int split_mask_len, int reduced_mask_len, int reorder_loc_len, float *__restrict__ A, float *__restrict__ B, int *__restrict__ reduced_mask, int *__restrict__ out_in_map, int *__restrict__ reorder_loc, float *__restrict__ C)
{
...
__global__ void __launch_bounds__(64) conv_backward_cuda_setting2_mode1_f32f32f32(int M_fwd, int64_t K_original, int64_t N, int kernel_volume, int split_k_iters, int split_mask_len, int reduced_mask_len, int reorder_loc_len, float *__restrict__ A, float *__restrict__ B, int *__restrict__ reduced_mask, int *__restrict__ out_in_map, int *__restrict__ reorder_loc, float *__restrict__ C)
{
    ...
    bool allow_tf32, bool allow_bf16)
{
  ...
  if (is_bf16)
  {
    ...
    else
    {
      ...
      // conv_backward_cuda_setting1_mode1_bf16bf16f32<<<num_blocks, threads_per_block>>>(
